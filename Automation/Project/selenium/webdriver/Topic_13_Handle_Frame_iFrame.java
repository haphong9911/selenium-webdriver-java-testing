...
public class Topic_13_Handle_Frame_iFrame {
	...
	public void TC_01_Kyna() {
		...
		//Switch vào frame/iframe  trước rồi mới thao tác lên element thược frame/iframe đó
		//A ->B
	...
	public void TC_02_Blog() {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//a[text()='Automation FC']/parent::div/following-sibling::div")).getText(), "3,242 likes");
	}
