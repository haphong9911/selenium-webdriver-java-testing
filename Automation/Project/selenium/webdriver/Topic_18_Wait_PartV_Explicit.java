...
public class Topic_18_Wait_PartV_Explicit {
	...
	public void TC_04_ajaxLoading()  {
		...
		//Sau khi click vao ngay do thi element da duoc update lai -> neu dung lai element o tren de find thi sai
		...
		WebElement todaySeleted = explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//td[@class='rcSelected']/a[text()='2']")));
	...
	public void TC_05_uploadFiles()  {
		...
		WebElement uploadText = explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='col-auto text-center']//div[text()='Your files have been successfully uploaded']")));
